...
public class BlockchainException extends KinEcosystemException {
	...
	@IntDef({ACCOUNT_CREATION_FAILED, ACCOUNT_NOT_FOUND,
		...
		TRANSACTION_FAILED, ACCOUNT_LOADING_FAILED, ACCOUNT_CREATION_TIMEOUT, BLOCKCHAIN_VERSIONS_ARE_NOT_THE_SAME, UNKNOWN})
	...
	public static final int BLOCKCHAIN_VERSIONS_ARE_NOT_THE_SAME = 6008;
